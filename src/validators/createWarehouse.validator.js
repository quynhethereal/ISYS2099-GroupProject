...
const validateCreateWarehousePayload = (params) => {
    ...
    return !(typeof params.name !== 'string' || typeof params.province !== 'string' || typeof params.city !== 'string' || typeof params.district !== 'string' || typeof params.street !== 'string' || typeof params.number !== 'string' || typeof params.total_volume !== 'number' || typeof params.available_volume !== 'number');
}
